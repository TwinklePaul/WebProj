				...
				<div class="row">
					...
					<div class="leftcolumn">
						...
						<?php
							...
							$sql="select * from user_data where $option='$data'";
							$result=mysqli_query($conn,$sql);
							if ($result)
							{
								echo "<br><u><b>TOTAL STUDENT(S): </b></u>".mysqli_num_rows($result);
						...
						<form id="recheck" action="http://localhost/FinalProject/phps/admin.php" method="post"> 
							<td><input type="submit" value="RECHECK" ></td>
						</form>
						</table>
						</p>
						</div>
